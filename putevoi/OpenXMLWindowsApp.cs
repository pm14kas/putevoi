...
namespace OpenXML
{
    public static class OpenXMLWindowsApp
    {
      /*  public void UpdateSheet()
        ...
        public static void UpdateCell(SpreadsheetDocument spreadSheet, string text,
            uint rowIndex, string columnName)
        {
            // Open the document for editing.

                WorksheetPart worksheetPart =
                      GetWorksheetPartByName(spreadSheet, "template");
